...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.authenticationService.login(this.f.username.value, this.f.password.value)
            ...
            if (data['status'] === 'err') {
                _this.alertService.error(data['err'], true);
                _this.loading = false;
            }
            else {
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http, connectionService) {
        this.http = http;
...
var TweetService = /** @class */ (function () {
    function TweetService(http, connection) {
        this.http = http;
    ...
    TweetService.prototype.creatTweet = function (tweet) {
...
var UserService = /** @class */ (function () {
    function UserService(http, connection) {
        this.http = http;
        this.connection = connection;
        this.apiUrl = '';
        this.apiUrl = connection.get_backend_dns();
...
var TweetHandlerComponent = /** @class */ (function () {
    function TweetHandlerComponent(authenticationService, tweetService, alertService, router) {
        this.authenticationService = authenticationService;
    ...
    Object.defineProperty(TweetHandlerComponent.prototype, "listFilter", {
        get: function () {
    ...
    TweetHandlerComponent.prototype.perform_filter = function (filter_by) {
        filter_by = filter_by.toLowerCase();
        return this.tweet_list.filter(function (tweet) {
            return tweet.tags.toString().toLowerCase().indexOf(filter_by) != -1;
        });
    };
    TweetHandlerComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.tweetService.getTweets()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])())
            .subscribe(function (data) {
            _this.tweet_list = data;
            _this.tweet_list_filter = _this.tweet_list;
        });
    };
    TweetHandlerComponent.prototype.deleteTweet = function (tweet) {
        var _this = this;
        this.alertService.clear();
        ...
        this.tweetService.deleteTweet(tweet)
            ...
            if (data['status'] == 'err') {
                ...
                _this.alertService.success(data['done'], true);
                _this.router.navigate(['/login']);
            }
        });
    };
    TweetHandlerComponent.ctorParameters = function () { return [
        { type: _services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"] },
...
var TweetCreatorComponent = /** @class */ (function () {
    function TweetCreatorComponent(authenticationService, tweetService, formBuilder, alertService, datePipe, router) {
        this.authenticationService = authenticationService;
        this.tweetService = tweetService;
        this.formBuilder = formBuilder;
        this.alertService = alertService;
    ...
    TweetCreatorComponent.prototype.ngOnInit = function () {
        this.tweetForm = this.formBuilder.group({
            title: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            body: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
        });
    };
    Object.defineProperty(TweetCreatorComponent.prototype, "f", {
        // convenience getter for easy access to form fields
        get: function () { return this.tweetForm.controls; },
        enumerable: true,
        configurable: true
    });
    TweetCreatorComponent.prototype.onSubmit = function () {
        var _this = this;
        this.submitted = true;
        this.alertService.clear();
        // stop here if form is invalid
    ...
    TweetCreatorComponent.ctorParameters = function () { return [
